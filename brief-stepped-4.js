let briefHench = {
	...
	getScore: function() {
		...
		} else if ( self.formSchema['frontendSalesQualificationScore'] === 0 || self.formSchema['frontendSalesQualificationScore'] === 1 || self.formSchema['frontendSalesQualificationScore'] === 2 ) {
